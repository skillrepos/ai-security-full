...
frameworks like Guardrails.ai and NeMo Guardrails. Input guards run BEFORE the
...
def _category(detail):
    """Pull the MLCommons category line (e.g. 'S9') out of the classifier output."""
...
def main():
    ...
    print("Each request: safety classifier + your INPUT guards -> model -> your OUTPUT guards + classifier\n")
    inputs = [
    ...
    for user_input in inputs:
        ...
        if verdict_out == "BLOCK":
            ...
            continue
        # Layer 3 - the safety classifier screens the model's output
